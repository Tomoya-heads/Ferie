...
<section class="<?php echo $secName;?>">
  ...
  <!-- 01 -->
    <div class="<?php echo $secName;?>__sec">
      <div class="<?php echo $secName;?>__ttl font-ja">森の中<small>で</small>あなただけ<small>の</small><br>休暇<small>を</small></div>
    </div>
    <!-- 02 -->
    <div class="<?php echo $secName;?>__sec">
      <div class="<?php echo $secName;?>__container">
        ...
        都会の喧騒から離れ、自然に囲まれたロッジで、大切なひとと大切な時間をゆっくり過ごしてください<br>
        浅間高原の大自然が温かく迎えてくれます
      </div>
    </div>
    <!-- 03 -->
